...
public class MyBatisConfig {
    ...
    @Bean
    @Primary
    public DynamicDataSource dataSource(@Qualifier("myTestDbDataSource") DataSource db1,
                                        @Qualifier("myTestDb2DataSource") DataSource db2) {
        ...
        dataSource.setDefaultTargetDataSource(db1);// 默认的datasource设置为myTestDbDataSource
